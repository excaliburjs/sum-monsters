/* Zepto v1.2.0 - zepto event ajax form ie - zeptojs.com/license */ !function(t, e) {
    ...
    var e = function() {
        ...
        var e, n, r, i, O, P, o = [], s = o.concat, a = o.filter, u = o.slice, f = t.document, c = {}, l = {}, h = {
            ...
            "z-index": 1,
            zoom: 1
        }, p = /^\s*<(\w+|!)[^>]*>/, d = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, m = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, g = /^(?:body|html)$/i, v = /([A-Z])/g, y = [
            "val",
            "css",
            "html",
            "text",
        ...
        return N.matches = function(t, e) {
            ...
            return t.getElementById && s && r ? (n = t.getElementById(o)) ? [
                n
            ] : [] : 1 !== t.nodeType && 9 !== t.nodeType && 11 !== t.nodeType ? [] : u.call(s && !r && t.getElementsByClassName ? i ? t.getElementsByClassName(o) : t.getElementsByTagName(e) : t.querySelectorAll(e));
    ...
    return t.Zepto = e, void 0 === t.$ && (t.$ = e), function(e) {
        ...
        function v(t, e) {
            var n = e.context;
            return e.beforeSend.call(n, t, e) === !1 || d(e, n, "ajaxBeforeSend", [
                t,
                e
            ]) === !1 ? !1 : void d(e, n, "ajaxSend", [
                t,
                e
            ]);
        }
        function y(t, e, n, r) {
            ...
            n.success.call(i, t, o, e), r && r.resolveWith(i, [
                t,
                o,
                e
            ]), d(n, i, "ajaxSuccess", [
        ...
        function x(t, e, n, r, i) {
            var o = r.context;
            r.error.call(o, n, e, t), i && i.rejectWith(o, [
                n,
                e,
                t
            ]), d(r, o, "ajaxError", [
        ...
        function b(t, e, n) {
            var r = n.context;
            n.complete.call(r, e, t), d(n, r, "ajaxComplete", [
                e,
                n
            ]), g(n);
        }
                ...
                if (4 == N.readyState) {
                    ...
                    if (N.status >= 200 && N.status < 300 || 304 == N.status || 0 == N.status && "file:" == C) {
                        if (c = c || w(s.mimeType || N.getResponseHeader("content-type")), "arraybuffer" == N.responseType || "blob" == N.responseType) t = N.response;
                            ...
                            t = N.responseText;
                            try {
                                t = E(t, c, s), "script" == c ? (0, eval)(t) : "xml" == c ? t = N.responseXML : "json" == c && (t = l.test(t) ? null : e.parseJSON(t));
                            } catch (r) {
                                n = r;
                            }
...
//# sourceMappingURL=index.1a1f300c.js.map
